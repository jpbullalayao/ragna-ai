...
This directory is the **Vercel deploy root** for the agent (run `eve link` and `eve deploy` from here). The package/project name is `research-agent`; the agent’s identity is **Ragna AI**.
